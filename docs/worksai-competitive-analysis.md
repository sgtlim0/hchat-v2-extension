# WorksAI 경쟁 분석 & H Chat 구현 방안

> 분석 일시: 2026-03-03
> 대상: wrks.ai (WorksAI) — 기업용 AI 업무 도구 플랫폼
...
### 스크린샷 2: 문서 번역 도구 (wrks.ai/ko/tools/translation)
...
### 스크린샷 3: 문서 작성 도구 (wrks.ai/ko/tools/docs)
...
### 스크린샷 4: OCR/텍스트 추출 (wrks.ai/ko/tools/ocr)
...
### 스크린샷 5: 마이페이지/요금제 (wrks.ai/ko/my-page)
...
## 2. 기능 갭 분석 (H Chat vs WorksAI)

| 기능 | WorksAI | H Chat v3.6 | 갭 |
|------|---------|-------------|-----|
...
WorksAI의 핵심 차별점. 현재 H Chat 페르소나가 시스템 프롬프트만 변경하는 것에 비해, 비서는 **도구 + 프롬프트 + 파라미터 + 아바타**를 묶은 패키지.
...
| **무료** | WorksAI 유료 vs H Chat 사용자 API 키로 무제한 |
