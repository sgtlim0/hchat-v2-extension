...
export const MODELS: ModelDef[] = [
  { id: 'us.anthropic.claude-sonnet-4-6-20250514-v1:0', provider: 'claude', label: 'Claude Sonnet 4.6 (권장)', shortLabel: 'Sonnet 4.6', emoji: '🟣' },
  { id: 'us.anthropic.claude-opus-4-6-20250514-v1:0', provider: 'claude', label: 'Claude Opus 4.6 (최고 성능)', shortLabel: 'Opus 4.6', emoji: '🟣' },
