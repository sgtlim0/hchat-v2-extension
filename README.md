...
└── src/
    ...
    │   ├── docTemplateStore.ts     # 템플릿 갤러리 CRUD, Base64 인코딩
...
### 규모 비교
| 항목 | v1 | v2 | v3 | v3.6 | v4.2 | v4.3 | v4.4 |
|------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| 소스 파일 | ~22개 | ~40개 | ~50개 | ~80개 | ~90개 | ~100개 | ~105개 |
| 코드 라인 | ~4,000 | ~8,000 | ~10,000+ | ~15,000+ | ~18,000+ | ~20,000+ | ~21,000+ |
| 탭 수 | 5개 | 7개 | 8개 | 8개 | 8개 | 8개 | 8개 |
| lib 파일 | 6개 | 20개 | 30개 | 45개 | 50개 | 55개 | 56개 |
| AI 프로바이더 | 1개 | 1개 | 3개 | 3개 | 3개 | 3개 | 3개 |
| 지원 모델 | 3개 | 3개 | 9개 | 9개 | 9개 | 9개 | 9개 |
| 도구 | 4개 | 8개 | 8개 | 12개 | 15개 | 16개 | 16개 |
| 테스트 | 0개 | 0개 | 0개 | 365개 | 498개 (30 파일) | 589개 (34 파일) | 620개 (35 파일) |
| i18n 키 | 0개 | 0개 | 0개 | 420+ | 600+ (3개 언어) | 650+ (3개 언어) | 660+ (3개 언어) |
