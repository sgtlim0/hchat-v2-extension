...
- **짧은 설명** (132자 이내): AWS Bedrock, OpenAI, Gemini를 하나의 사이드바에서. 커스텀 비서, 문서 번역, 데이터 분석, 이미지 생성, 딥 리서치.
- **카테고리**: Productivity
- **언어**: 한국어, English, 日本語
...
- **문서 번역**: TXT/CSV/XLSX 포맷 유지 번역, 용어 일관성, 비용 추정
- **문서 작성**: AI 자동 문서 생성 (보고서/이메일/제안서/회의록/메모 → DOCX)
