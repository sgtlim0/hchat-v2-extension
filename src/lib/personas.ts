...
export const BUILTIN_PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    description: '데이터 분석, 인사이트 도출, 시각화',
    builtin: true,
    createdAt: 0,
  },
  {
